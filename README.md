...
### 🌐 [Acceder a la Web App](https://roanicolasrw-cmyk.github.io/CSEMAL/)
...
2.  **La publico**: Registra los datos en la WebApp en segundos.
...
*   **Frontend**: Una Web App liviana (HTML/JS) que funciona en cualquier celular.
